...
export function Livros() {
  ...
  return (
    <section className="module-page students-page books-page">
      ...
      {formOpen && <LocationFields form={form} updateField={updateField} prateleiras={prateleiras} secoes={secoes} />}
